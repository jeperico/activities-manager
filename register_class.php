...
<html lang="pt-BR">
    ...
    <body>
        <header class="bg-blue text-white p-4 flex justify-between items-center">
            ...
            <div>
            <a href="teacher.php" class="bg-green-500 px-4 py-2 rounded ml-2">Voltar para Home</a>
        ...
        <main class="w-main m-auto max-w-mainmx py-10 flex items-center justify-center h-[84vh]">
            <div class="bg-white p-8 rounded shadow w-full max-w-sm">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="w-full bg-blue text-white px-4 py-2 rounded">Registrar</button>
                </form>
            </div>
        </main>
        <?php
